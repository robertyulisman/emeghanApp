...
const DetailLapangan = ({navigation}) => {
  const {data} = navigation.state.params;
  return (
    <View style={{flex: 1, backgroundColor: Warna.putih}}>
      <TopBarNew title="Detail Lapangan" />
      <ScrollView
      ...
      <Tombol
        onPress={() => navigation.navigate('OrderFutsal', {data: data})}
...
export default withNavigation(DetailLapangan);
